...
## [19.0.0](https://github.com/tahsintunan/zksync-era/compare/prover-v18.0.0...prover-v19.0.0) (2025-02-19)


### ⚠ BREAKING CHANGES

* **contracts:** gateway integration ([#1934](https://github.com/tahsintunan/zksync-era/issues/1934))
* force minor bump for provers release -- v25 ([#3208](https://github.com/tahsintunan/zksync-era/issues/3208))
...
* Add min_replicas for SimpleScaler, apply_min_to_namespace config  ([#3282](https://github.com/tahsintunan/zksync-era/issues/3282)) ([bc00c4a](https://github.com/tahsintunan/zksync-era/commit/bc00c4a44a212def3cc25567f3b271530d76b6a4))
...
* Bump crypto and protocol deps ([#2825](https://github.com/tahsintunan/zksync-era/issues/2825)) ([a5ffaf1](https://github.com/tahsintunan/zksync-era/commit/a5ffaf1b4e291d6f09ba8c1f224f5900665bffc4))
...
* force minor bump for provers release -- v25 ([#3208](https://github.com/tahsintunan/zksync-era/issues/3208)) ([6851e35](https://github.com/tahsintunan/zksync-era/commit/6851e353f01cde5d385403dedb68bcae76d06966))
...
* **prover:** Add cluster name autodetection ([#3227](https://github.com/tahsintunan/zksync-era/issues/3227)) ([bd32aec](https://github.com/tahsintunan/zksync-era/commit/bd32aecdf982c51202c1a69d12fcf1d878fe6d05))
...
* **prover:** Add gpu_checker binary ([#3573](https://github.com/tahsintunan/zksync-era/issues/3573)) ([51b9a03](https://github.com/tahsintunan/zksync-era/commit/51b9a03941a9836fb9cda92ced35c10a92ab4e3f))
...
* **prover:** Add scale failure events watching and pods eviction. ([#3175](https://github.com/tahsintunan/zksync-era/issues/3175)) ([dd166f8](https://github.com/tahsintunan/zksync-era/commit/dd166f887b11a8dfb039a0030dda923c481f67af))
...
* **prover:** Autoscaler sends scale request to appropriate agents. ([#3150](https://github.com/tahsintunan/zksync-era/issues/3150)) ([bfedac0](https://github.com/tahsintunan/zksync-era/commit/bfedac03b53055c6e2d5fa6bd6bdc78e2cb1724c))
...
* **prover:** Refactor WitnessGenerator ([#2845](https://github.com/tahsintunan/zksync-era/issues/2845)) ([934634b](https://github.com/tahsintunan/zksync-era/commit/934634b149377c730ec39e904508c40628ff4019))
* **prover:** Update witness generator to zkevm_test_harness 0.150.6 ([#3029](https://github.com/tahsintunan/zksync-era/issues/3029)) ([2151c28](https://github.com/tahsintunan/zksync-era/commit/2151c2832498ca6e7ee1eee0bfdf6a0568345fee))
* **prover:** Use query macro instead string literals for queries ([#2930](https://github.com/tahsintunan/zksync-era/issues/2930)) ([1cf959d](https://github.com/tahsintunan/zksync-era/commit/1cf959da12d2b6369f34a67ccc2575b4b173d75a))
* **prover:** WG refactoring [#3](https://github.com/tahsintunan/zksync-era/issues/3) ([#2942](https://github.com/tahsintunan/zksync-era/issues/2942)) ([df68762](https://github.com/tahsintunan/zksync-era/commit/df6876221936a44fa2fb8c80c01d043d229621fc))
* **prover:** WitnessGenerator refactoring [#2](https://github.com/tahsintunan/zksync-era/issues/2) ([#2899](https://github.com/tahsintunan/zksync-era/issues/2899)) ([36e5340](https://github.com/tahsintunan/zksync-era/commit/36e534091f73f4e3ce86e322fb20842cda6a6b61))
* Refactor WG DAL ([#3560](https://github.com/tahsintunan/zksync-era/issues/3560)) ([d1ede36](https://github.com/tahsintunan/zksync-era/commit/d1ede36dc17d750baa7c76d6c027e8d0e9385c7e))
...
* Updating information about keys & commitments for releases ([#3486](https://github.com/tahsintunan/zksync-era/issues/3486)) ([cd21c9e](https://github.com/tahsintunan/zksync-era/commit/cd21c9ea31192889d83d85be549290cd99c7bba6))
...
* **zk_toolbox:** deploy legacy bridge ([#2837](https://github.com/tahsintunan/zksync-era/issues/2837)) ([93b4e08](https://github.com/tahsintunan/zksync-era/commit/93b4e08257802d11108870d867dd59fa35e52733))
...
* Add prometheus exporter to circut prover ([#3311](https://github.com/tahsintunan/zksync-era/issues/3311)) ([920eba1](https://github.com/tahsintunan/zksync-era/commit/920eba15fc64b40f10fcc9f6910d5e7607f3d313))
* added missing quote in prover query ([#3347](https://github.com/tahsintunan/zksync-era/issues/3347)) ([668ca51](https://github.com/tahsintunan/zksync-era/commit/668ca51f5d52646e64b19b973acec05daa1c6f09))
* allow compilation under current toolchain ([#3176](https://github.com/tahsintunan/zksync-era/issues/3176)) ([89eadd3](https://github.com/tahsintunan/zksync-era/commit/89eadd353c4fb84bb815ae56b29f4ff3467b80f3))
* Allow witness_generator to use Prometheus push gateway in continuous mode ([#3555](https://github.com/tahsintunan/zksync-era/issues/3555)) ([0f1a5e0](https://github.com/tahsintunan/zksync-era/commit/0f1a5e0d61fbd7a2755bae6191184039f1c46e03))
...
* Compressor setup data ([#3526](https://github.com/tahsintunan/zksync-era/issues/3526)) ([62aea8b](https://github.com/tahsintunan/zksync-era/commit/62aea8b4dcd986587de2cf17979e1042307d6b3e))
...
* Fix Doc lint. ([#3158](https://github.com/tahsintunan/zksync-era/issues/3158)) ([c79949b](https://github.com/tahsintunan/zksync-era/commit/c79949b8ffde9867b961192afa6c815b44865ae4))
...
* **prover:** Create reqwest client only once ([#3324](https://github.com/tahsintunan/zksync-era/issues/3324)) ([40f8123](https://github.com/tahsintunan/zksync-era/commit/40f8123a67970efbba3519f7954f807958a76cff))
* **prover:** Do not exit on missing watcher data. ([#3119](https://github.com/tahsintunan/zksync-era/issues/3119)) ([76ed6d9](https://github.com/tahsintunan/zksync-era/commit/76ed6d966051c56f8e894c18461c5ea284b1a74b))
* **prover:** fix setup_metadata_to_setup_data_key ([#2875](https://github.com/tahsintunan/zksync-era/issues/2875)) ([4ae5a93](https://github.com/tahsintunan/zksync-era/commit/4ae5a93e9e96cd0cd529baf9ffa78c1b21a9c4b1))
* **prover:** Remove unneeded dependencies, add default for graceful_shutdown_timeout ([#3242](https://github.com/tahsintunan/zksync-era/issues/3242)) ([1bfff0e](https://github.com/tahsintunan/zksync-era/commit/1bfff0e007e2fb5a4b4b885cf5c69a5cd290888b))
...
* Simplify prover_jobs_fri indices ([#3577](https://github.com/tahsintunan/zksync-era/issues/3577)) ([559edc3](https://github.com/tahsintunan/zksync-era/commit/559edc34617e89c5d37e6a569b5d7a0740abdc46))
...
* Add prover jobs as one multi-insert for Witness Generator ([#3587](https://github.com/tahsintunan/zksync-era/issues/3587)) ([d150dca](https://github.com/tahsintunan/zksync-era/commit/d150dcaf767eca45237ba9605fa5ccbc9f3f63e2))
